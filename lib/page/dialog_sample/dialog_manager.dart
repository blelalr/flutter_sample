...
class DialogManager {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (component.description != null) Text('${component.description}'),
                      ListView(
                        shrinkWrap: true,
  ...
  static void showBottomSheet(BuildContext context, DialogComponent component) {
    showModalBottomSheet(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20), bottom: Radius.zero)),
        context: context,
        builder: (BuildContext buildContext) {
          return Container(
            child: Padding(
